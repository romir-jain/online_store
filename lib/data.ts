...
const products: IProductInput[] = [
  {
    ...
    images: ['/images/cutting-styling/woman.jpeg'],
    isPublished: true,
    price: 75,
  ...
  },
  {
    ...
    category: 'Cutting & Styling',
    images: ['/images/cutting-styling/man.jpg'],
    isPublished: true,
    price: 45,
    listPrice: 'Prices may vary depending on the style.',
    description: 'Need description here',
  ...
  },
  {
    ...
    images: ['/images/hair-color-chemicals/bang.webp'],
    isPublished: true,
    price: 15,
    description: 'Need description here',
  },
  ...
  },
  {
    ...
    category: 'Hair Color & Chemicals',
    images: ['/images/hair-color/global.jpeg'],
    isPublished: true,
    price: 50,
    description: `Great for all hair types to add incredible shine and protection,
     can be added to any colour service or as a Stand alone gloss.
...
export const brands = [
  {
    name: 'Olaplex',
    image: '/images/brands/opalex.jpg',
  },
  {
    name: 'Keratin Complex',
    image: '/images/brands/keratin.jpg',
  },
  {
    name: 'Marocconoil',
    image: '/images/brands/marocconoil..jpeg',
  },
  {
    name: 'Redken',
    image: '/images/brands/redken.jpg',
  },
]
